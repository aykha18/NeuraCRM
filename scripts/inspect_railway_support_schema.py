#!/usr/bin/env python3
"""
Inspect Railway Support Schema
=============================

This script inspects the actual schema of support tables in Railway.
"""
...
def inspect_support_schema():
    """Inspect the schema of support tables"""
    try:
        ...
        # Check support tables schema
        support_tables = ['support_queues', 'call_queue_members']
